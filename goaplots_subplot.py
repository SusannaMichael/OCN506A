...
plt.subplots_adjust(left=0.1, bottom=0.2, right=0.9, top=0.9, wspace=0.3, hspace=0.15)
...
axs[0,0].legend(fontsize=12, ncol=1, loc = 7)
...
#DMn plot
axs[0,1].plot(april_dist, april_DMn,'#014F94', marker = 'D', fillstyle ='none',linewidth=0, markersize = '7', label = 'April')
axs[0,1].plot(may_dist,may_DMn,'#00877B' , marker = 'D', fillstyle ='none',linewidth=0, markersize ='7', label = 'May')
axs[0,1].plot(july_dist,july_DMn,'#CB7941', marker = 'D',fillstyle ='none', linewidth=0, markersize='7', label = 'July')
axs[0,1].set_ylabel('DMn(nM)', color='black', size=fs,fontweight = 'bold')
...
ax2.plot(july_dist, july_sal,'#CB7841',marker = '+', linewidth=1)
ax2.set_ylabel('Salinity', color='black', size=fs,fontweight = 'bold')
#axs[0,1].set_title('DMn', fontsize=12)
axs[0,1].legend(fontsize=12, ncol=1, loc = 7)
#ax2.legend(fontsize=20, ncol=1, loc = 8)
axs[0,1].text(0,1.05, 'b.' , fontsize=fs, fontweight = 'bold', transform = axs[0,1].transAxes)
...
#TDAl plot
axs[1,0].plot(april_dist, april_TDAl,'#014F94', marker = 'o', linewidth=0, markersize = '7', label = 'April')
axs[1,0].plot(may_dist,may_TDAl,'#00877B' , marker = 'o', linewidth=0, markersize ='7', label = 'May')
axs[1,0].plot(july_dist,july_TDAl,'#CB7941', marker = 'o', linewidth=0, markersize='7', label = 'July')
axs[1,0].set_ylabel('TDAl(nM)', color='black', size=fs,fontweight = 'bold')
axs[1,0].set_xlabel('Distance from Shore(km)' ,fontweight = 'bold')
...
ax2.plot(july_dist, july_sal,'#CB7841',marker = '+', linewidth=1)
ax2.set_ylabel('Salinity', color='black', size=fs,fontweight = 'bold')
#axs[1,0].set_title('TDAl', fontsize=24)
axs[1,0].legend(fontsize=12, ncol=1, loc = 7)
#ax2.legend(fontsize=20, ncol=1, loc = 8)
axs[1,0].text(0,1.05, 'c.' , fontsize=fs, fontweight = 'bold', transform = axs[1,0].transAxes)
axs[1,0].tick_params(direction='in')
axs[1,0].tick_params(which = 'minor', direction='in')
ax2.tick_params(direction = 'in')

#TDMn plot
axs[1,1].plot(april_dist, april_TDMn,'#014F94', marker = 'D', linewidth=0, markersize = '7', label = 'April')
axs[1,1].plot(may_dist,may_TDMn,'#00877B' , marker = 'D', linewidth=0, markersize ='7', label = 'May')
axs[1,1].plot(july_dist,july_TDMn,'#CB7941', marker = 'D', linewidth=0, markersize='7', label = 'July')
axs[1,1].set_ylabel('TDMn(nM)', color='black', size=fs,fontweight = 'bold')
axs[1,1].set_xlabel('Distance from Shore(km)',fontweight = 'bold')
...
axs[1,1].legend(fontsize=12, ncol=1, loc = 1)
ax2.legend(fontsize=fs, ncol=1, loc = 7)
axs[1,1].text(0,1.05, 'd.' , fontsize=fs, fontweight = 'bold', transform = axs[1,1].transAxes)
axs[1,1].tick_params(direction='in')
axs[1,1].tick_params(which = 'minor', direction='in')
ax2.tick_params(direction = 'in')

plt.show()
fig.savefig(out_dir + 'GoA_allPlots.png')